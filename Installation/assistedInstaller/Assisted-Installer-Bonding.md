...
$ curl -H "Authorization: Bearer $TOKEN" -H "Content-Type: application/json"  -X ^CTCH -d @$request_body ${ASSISTED_SERVICE_URL}/api/assisted-install/v2/infra-envs/${INFRA_ID}
