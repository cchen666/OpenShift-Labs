...
$  curl -k https://api.master.paas.XXXXXX.com.com -w "%{time_connect},%{time_total},%{speed_download},%{http_code},%{size_download},%{url_effective}\n"
0.617,3.714,0.000,302,0,https://api.master.paas.XXXXXX.com.com/
```
