#### To check which resources are provided by which apiserver; Local means it is provided by k8s or CRD while openshift-apiserver/api means it is provided by openshift
